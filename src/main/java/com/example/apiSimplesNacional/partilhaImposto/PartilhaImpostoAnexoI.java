...
@Service
public class PartilhaImpostoAnexoI {
	
	private Double irpj_1faixa = 0.0550;
	private Double csll_1faixa = 0.0350;
	private Double cofins_1faixa = 0.1274;
	private Double pis_1faixa = 0.0276;
	private Double cpp_1faixa = 0.4150;
	private Double icms_1faixa = 0.34;
	
	private Double irpj_2faixa = 0.0550;
	private Double csll_2faixa = 0.0350;
	private Double cofins_2faixa = 0.1274;
	private Double pis_2faixa = 0.0276;
	private Double cpp_2faixa = 0.4150;
	private Double icms_2faixa = 0.34;
	
	private Double irpj_3faixa = 0.0550;
	private Double csll_3faixa = 0.0350;
	private Double cofins_3faixa = 0.1274;
	private Double pis_3faixa = 0.0276;
	private Double cpp_3faixa = 0.42;
	private Double icms_3faixa = 0.3350;
	
	private Double irpj_4faixa = 0.0550;
	private Double csll_4faixa = 0.0350;
	private Double cofins_4faixa = 0.1274;
	private Double pis_4faixa = 0.0276;
	private Double cpp_4faixa = 0.42;
	private Double icms_4faixa = 0.3350;
	
	private Double irpj_5faixa = 0.0550;
	private Double csll_5faixa = 0.0350;
	private Double cofins_5faixa = 0.1274;
	private Double pis_5faixa = 0.0276;
	private Double cpp_5faixa = 0.42;
	private Double icms_5faixa = 0.3350;
	
	private Double irpj_6faixa = 0.1350;
	private Double csll_6faixa = 0.10;
	private Double cofins_6faixa = 0.2827;
	private Double pis_6faixa = 0.0613;
	private Double cpp_6faixa = 0.4210;
	private Double icms_6faixa = 0.00;
	
	public PartilhaImpostoAnexoI() {
	}

	public PartilhaImpostoAnexoI(Double irpj_1faixa, Double csll_1faixa, Double cofins_1faixa, Double pis_1faixa,
