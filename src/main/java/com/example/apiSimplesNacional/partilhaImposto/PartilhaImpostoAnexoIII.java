...
public class PartilhaImpostoAnexoIII {

	private Double irpj_1faixa = 0.04;
	private Double csll_1faixa = 0.0350;
	private Double cofins_1faixa = 0.1282;
	private Double pis_1faixa = 0.0278;
	private Double cpp_1faixa = 0.4340;
	private Double icms_1faixa = 0.3350;
	
	private Double irpj_2faixa = 0.04;
	private Double csll_2faixa = 0.0350;
	private Double cofins_2faixa = 0.1405;
	private Double pis_2faixa = 0.0305;
	private Double cpp_2faixa = 0.4340;
	private Double icms_2faixa = 0.32;
	
	private Double irpj_3faixa = 0.04;
	private Double csll_3faixa = 0.0350;
	private Double cofins_3faixa = 0.1364;
	private Double pis_3faixa = 0.0296;
	private Double cpp_3faixa = 0.4340;
	private Double icms_3faixa = 0.3250;
	
	private Double irpj_4faixa = 0.04;
	private Double csll_4faixa = 0.0350;
	private Double cofins_4faixa = 0.1364;
	private Double pis_4faixa = 0.0296;
	private Double cpp_4faixa = 0.4340;
	private Double icms_4faixa = 0.3250;
	
	private Double irpj_5faixa = 0.04;
	private Double csll_5faixa = 0.0350;
	private Double cofins_5faixa = 0.1282;
	private Double pis_5faixa = 0.0278;
	private Double cpp_5faixa = 0.4340;
	private Double icms_5faixa = 0.3350;
	
	private Double irpj_6faixa = 0.35;
	private Double csll_6faixa = 0.15;
	private Double cofins_6faixa = 0.1603;
	private Double pis_6faixa = 0.0347;
	private Double cpp_6faixa = 0.3050;
	private Double icms_6faixa = 0.00;
	
	public PartilhaImpostoAnexoIII() {
	}

	public PartilhaImpostoAnexoIII(Double irpj_1faixa, Double csll_1faixa, Double cofins_1faixa, Double pis_1faixa,
			Double cpp_1faixa, Double icms_1faixa, Double irpj_2faixa, Double csll_2faixa, Double cofins_2faixa,
			Double pis_2faixa, Double cpp_2faixa, Double icms_2faixa, Double irpj_3faixa, Double csll_3faixa,
			Double cofins_3faixa, Double pis_3faixa, Double cpp_3faixa, Double icms_3faixa, Double irpj_4faixa,
			Double csll_4faixa, Double cofins_4faixa, Double pis_4faixa, Double cpp_4faixa, Double icms_4faixa,
			Double irpj_5faixa, Double csll_5faixa, Double cofins_5faixa, Double pis_5faixa, Double cpp_5faixa,
			Double icms_5faixa, Double irpj_6faixa, Double csll_6faixa, Double cofins_6faixa, Double pis_6faixa,
			Double cpp_6faixa, Double icms_6faixa) {
		super();
