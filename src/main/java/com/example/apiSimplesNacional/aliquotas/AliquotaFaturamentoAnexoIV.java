...
public class AliquotaFaturamentoAnexoIV {
	
	private Double faixa1 = 0.045;
	private Double faixa2 = 0.09;
	private Double faixa3 = 0.102;
	private Double faixa4 = 0.14;
	private Double faixa5 = 0.22;
	private Double faixa6 = 0.33;
	
	private int deducao_faixa1 = 0;
	private int deducao_faixa2 = 8100;
	private int deducao_faixa3 = 12420;
	private int deducao_faixa4 = 39780;
	private int deducao_faixa5 = 183780;
	private int deducao_faixa6 = 828000;
	
	public AliquotaFaturamentoAnexoIV() {
	}

	public AliquotaFaturamentoAnexoIV(Double faixa1, Double faixa2, Double faixa3, Double faixa4, Double faixa5,
