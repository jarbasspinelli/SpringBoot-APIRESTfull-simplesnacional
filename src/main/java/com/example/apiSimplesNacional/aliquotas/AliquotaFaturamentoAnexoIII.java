...
public class AliquotaFaturamentoAnexoIII {
	
	private Double faixa1 = 0.06;
	private Double faixa2 = 0.1120;
	private Double faixa3 = 0.1350;
	private Double faixa4 = 0.1600;
	private Double faixa5 = 0.21;
	private Double faixa6 = 0.33;
	
	private int deducao_faixa1 = 0;
	private int deducao_faixa2 = 9360;
	private int deducao_faixa3 = 17640;
	private int deducao_faixa4 = 35640;
	private int deducao_faixa5 = 125640;
	private int deducao_faixa6 = 648000;

	public AliquotaFaturamentoAnexoIII() {
	}

	public AliquotaFaturamentoAnexoIII(Double faixa1, Double faixa2, Double faixa3, Double faixa4, Double faixa5,
