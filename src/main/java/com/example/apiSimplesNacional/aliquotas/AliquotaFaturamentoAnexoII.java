...
@Service
public class AliquotaFaturamentoAnexoII {
	
	private Double faixa1 = 0.045;
	private Double faixa2 = 0.078;
	private Double faixa3 = 0.10;
	private Double faixa4 = 0.1120;
	private Double faixa5 = 0.1470;
	private Double faixa6 = 0.30;
	
	private int deducao_faixa1 = 0;
	private int deducao_faixa2 = 5940;
	private int deducao_faixa3 = 13860;
	private int deducao_faixa4 = 22500;
	private int deducao_faixa5 = 85500;
	private int deducao_faixa6 = 720000;
	
	public AliquotaFaturamentoAnexoII() {
	}

	public AliquotaFaturamentoAnexoII(Double faixa1, Double faixa2, Double faixa3, Double faixa4, Double faixa5,
